...
public class ProoviKontrolltoo {
    public static void main(String[] args) {
        double k = keskmiseLeidmine(21,3,2);
        System.out.println(k);
        List<Integer>integerList = new ArrayList<>(Arrays.asList(1, 3, 4, 6, 4, 3));
        Integer[] integers = {1, 3, 4, 7, 8, 5};
